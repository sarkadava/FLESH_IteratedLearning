...
datasets      <- paste0(parentfolder, '/Gillian_stats/datasets/') # This line is different on mac and other devices
...
Here we look into structure of our data
...
# Question One - gesture space, temporal variability, entropy
